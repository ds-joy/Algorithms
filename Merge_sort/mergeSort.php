...
if (isset($_POST['addComment']) && $loggedIn != 0) {
        ...
        <div class="col-3 col-lg-2 main">
            <ul class="list-group list-group-flush">
                <li class="list-group-item"> 
                    <a href="../Insertion_sort/insertion.php">Insertion Sort</a>
                </li>
                <li class="list-group-item"> 
                    <a href="mergeSort.php">Merge Sort</a>
                </li>
                <li class="list-group-item"> 
                    <a href="../Quick_sort/quickSort.php">Quick Sort</a>
                </li>
                <li class="list-group-item"> 
                    <a href="../BFS/bfs.php">Bfs</a>
                </li>
                <li class="list-group-item"> 
                        <a href="../DFS/dfs.php">Dfs</a>
                </li>
                <li class="list-group-item"> 
                    <a href="../PRIM/prims.html">Prim's Algorithm</a>
                </li>
                <li class="list-group-item"> 
                    <a href="../Kruskal/kruskal.php">Kruskal's Algorithm</a>
                </li>
                <li class="list-group-item"> 
                        <a href="../KnapsackBruteForce/KnapsackBrute.php">Knapsack Brute Force</a>
                    </li>
                <li class="list-group-item"> 
                    <a href="../KnapsackGreedy/knapsackGreedy.php">Knapsack(Greedy)</a>
                </li>
            </ul>
        </div> <!--col-3.. main div-->
