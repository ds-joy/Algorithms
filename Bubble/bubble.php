 ...
 //insert into reply
    if ($isReply != 'false') {
        $conn->query("INSERT INTO replies (comment, commentID, userID, createdOn, page_name) 
            /* here*/           VALUES ('$comment', '$commentID', '".$_SESSION['userID']."', NOW(), 'bubble')"
                      );
...
<!-- searching -->
                ...
                <ol>
                    ...
                    <li class="list-group-item"> 
                        <a href="../linear/binary.php"> <i> Binary Search </i> </a>
                    </li>
                </ol>
...
<div class="container" style="margin-top:50px;">
    ...
    <h1 id="top">Bubble Sort</h1> 
            ...
            <!-- here -->
            <h4 class="content"> Here is an animation explaining Bubble Sort: </h4>

            <!--A gif explaining insertion sort  -->
            <div class="anim_container">
                <img src="../Pic/Bubble-sort-example-300px.gif"  alt="Insertion-sort01" class="img_anim">
            </div>
    ...
    return 0;
        ...
        <!-- here -->
        <p class="content">The Complexity of Bubble Sort is: O( n <sup>2</sup> )</p> 
        <br>
        <br>
